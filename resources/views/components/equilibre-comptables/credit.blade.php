<div class="col-md-12 mb-2 row">
        ...
        <div class="col-md-4 text-right text-gray-900 font-weight-bold">compte crédit</div>
        <div class="col-md-8">
            <select name="" id="" wire:model.lazy="compte_credit_id" class="form-control @error('compte_credit_id') is-invalid @enderror">
                <option value=""></option>
    ...
    {{-- <div class=" col-md-12 mb-2 row">
        <div class="col-md-4 text-right text-gray-900 font-weight-bold">debut</div>
        <div class="col-md-8 ">
    ...
    <div class="col-md-12 mb-2 row">
        <div class="col-md-4 text-right text-gray-900 font-weight-bold">crédit</div>
        <div class="col-md-8 row ">
            ...
            <span type="button"   wire:click="form_credit">
